...
const AboutSection = () => {
  const features = [
    ...
    },
    {
      ...
      title: "Vision", 
      description: "To become Mysore's leading hub for sports and active living, creating a multi-sport ecosystem that nurtures talent, builds community, and inspires a healthy lifestyle."
    },
    {
      icon: <Users className="h-8 w-8" />,
      title: "Community",
      description: "Kreede is not just a facility—it's a lifestyle movement designed to foster active living and social engagement in Mysore."
    },
    {
      icon: <MapPin className="h-8 w-8" />,
      title: "Location",
      description: "Strategically located in Mysuru, Karnataka, bringing world-class sporting facilities to the heart of the city."
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Kreede is a Mysore-based company dedicated to transforming the city's recreational and fitness landscape. We are on a mission to create vibrant, inclusive, and accessible spaces where sports, community, and wellness come together.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-kreede-black text-kreede-cream rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="mt-8 inline-block px-6 py-3 bg-kreede-cream/10 rounded-full border border-kreede-cream/20">
              <span className="font-semibold">Building a legacy of movement, wellness, and community in Mysore</span>
            </div>
          </div>
        </div>
      </div>
